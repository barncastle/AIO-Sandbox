...
namespace WotLK_9056
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER__FIELD_KNOWN_TITLES1 = UNIT_END + 0x035A,
            PLAYER_FIELD_KNOWN_CURRENCIES = UNIT_END + 0x035C,
            PLAYER_XP = UNIT_END + 0x035E,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x035F,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x0360,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x04E0,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x04E1,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x04E2,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x04E3,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x04E4,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x04E5,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x04E6,
            PLAYER_EXPERTISE = UNIT_END + 0x04E7,
            PLAYER_OFFHAND_EXPERTISE = UNIT_END + 0x04E8,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x04E9,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x04EA,
            PLAYER_OFFHAND_CRIT_PERCENTAGE = UNIT_END + 0x04EB,
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x04EC,
            PLAYER_SHIELD_BLOCK = UNIT_END + 0x04F3,
            PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE = UNIT_END + 0x04F4,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x04F5,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x0575,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x0576,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x0577,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x057E,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x0585,
            PLAYER_FIELD_MOD_HEALING_DONE_POS = UNIT_END + 0x058C,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x058D,
            PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = UNIT_END + 0x058E,
            PLAYER_FIELD_BYTES = UNIT_END + 0x058F,
            PLAYER_AMMO_ID = UNIT_END + 0x0590,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x0591,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x0592,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x0593,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x059F,
            PLAYER_FIELD_KILLS = UNIT_END + 0x05AB,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x05AC,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x05AD,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x05AE,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x05AF,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x05B0,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x05B1,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x05CA,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x05DC,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x05DD,
