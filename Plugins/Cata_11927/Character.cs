...
namespace Cata_11927
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_VISIBLE_ITEM_1_ENTRYID = UNIT_END + 0x0088,
            PLAYER_VISIBLE_ITEM_1_ENCHANTMENT = UNIT_END + 0x0089,
            PLAYER_VISIBLE_ITEM_2_ENTRYID = UNIT_END + 0x008A,
            PLAYER_VISIBLE_ITEM_2_ENCHANTMENT = UNIT_END + 0x008B,
            PLAYER_VISIBLE_ITEM_3_ENTRYID = UNIT_END + 0x008C,
            PLAYER_VISIBLE_ITEM_3_ENCHANTMENT = UNIT_END + 0x008D,
            PLAYER_VISIBLE_ITEM_4_ENTRYID = UNIT_END + 0x008E,
            PLAYER_VISIBLE_ITEM_4_ENCHANTMENT = UNIT_END + 0x008F,
            PLAYER_VISIBLE_ITEM_5_ENTRYID = UNIT_END + 0x0090,
            PLAYER_VISIBLE_ITEM_5_ENCHANTMENT = UNIT_END + 0x0091,
            PLAYER_VISIBLE_ITEM_6_ENTRYID = UNIT_END + 0x0092,
            PLAYER_VISIBLE_ITEM_6_ENCHANTMENT = UNIT_END + 0x0093,
            PLAYER_VISIBLE_ITEM_7_ENTRYID = UNIT_END + 0x0094,
            PLAYER_VISIBLE_ITEM_7_ENCHANTMENT = UNIT_END + 0x0095,
            PLAYER_VISIBLE_ITEM_8_ENTRYID = UNIT_END + 0x0096,
            PLAYER_VISIBLE_ITEM_8_ENCHANTMENT = UNIT_END + 0x0097,
            PLAYER_VISIBLE_ITEM_9_ENTRYID = UNIT_END + 0x0098,
            PLAYER_VISIBLE_ITEM_9_ENCHANTMENT = UNIT_END + 0x0099,
            PLAYER_VISIBLE_ITEM_10_ENTRYID = UNIT_END + 0x009A,
            PLAYER_VISIBLE_ITEM_10_ENCHANTMENT = UNIT_END + 0x009B,
            PLAYER_VISIBLE_ITEM_11_ENTRYID = UNIT_END + 0x009C,
            PLAYER_VISIBLE_ITEM_11_ENCHANTMENT = UNIT_END + 0x009D,
            PLAYER_VISIBLE_ITEM_12_ENTRYID = UNIT_END + 0x009E,
            PLAYER_VISIBLE_ITEM_12_ENCHANTMENT = UNIT_END + 0x009F,
            PLAYER_VISIBLE_ITEM_13_ENTRYID = UNIT_END + 0x00A0,
            PLAYER_VISIBLE_ITEM_13_ENCHANTMENT = UNIT_END + 0x00A1,
            PLAYER_VISIBLE_ITEM_14_ENTRYID = UNIT_END + 0x00A2,
            PLAYER_VISIBLE_ITEM_14_ENCHANTMENT = UNIT_END + 0x00A3,
            PLAYER_VISIBLE_ITEM_15_ENTRYID = UNIT_END + 0x00A4,
            PLAYER_VISIBLE_ITEM_15_ENCHANTMENT = UNIT_END + 0x00A5,
            PLAYER_VISIBLE_ITEM_16_ENTRYID = UNIT_END + 0x00A6,
            PLAYER_VISIBLE_ITEM_16_ENCHANTMENT = UNIT_END + 0x00A7,
            PLAYER_VISIBLE_ITEM_17_ENTRYID = UNIT_END + 0x00A8,
            PLAYER_VISIBLE_ITEM_17_ENCHANTMENT = UNIT_END + 0x00A9,
            PLAYER_VISIBLE_ITEM_18_ENTRYID = UNIT_END + 0x00AA,
            PLAYER_VISIBLE_ITEM_18_ENCHANTMENT = UNIT_END + 0x00AB,
            PLAYER_VISIBLE_ITEM_19_ENTRYID = UNIT_END + 0x00AC,
            PLAYER_VISIBLE_ITEM_19_ENCHANTMENT = UNIT_END + 0x00AD,
            PLAYER_CHOSEN_TITLE = UNIT_END + 0x00AE,
            PLAYER_FAKE_INEBRIATION = UNIT_END + 0x00AF,
            ...
            PLAYER_FARSIGHT = UNIT_END + 0x019C,
            PLAYER__FIELD_KNOWN_TITLES = UNIT_END + 0x019E,
            PLAYER__FIELD_KNOWN_TITLES1 = UNIT_END + 0x01A0,
            PLAYER__FIELD_KNOWN_TITLES2 = UNIT_END + 0x01A2,
            PLAYER_XP = UNIT_END + 0x01A4,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x01A5,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x01A6,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x0326,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x0327,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x0328,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x0329,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x032A,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x032B,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x032C,
            PLAYER_EXPERTISE = UNIT_END + 0x032D,
            PLAYER_OFFHAND_EXPERTISE = UNIT_END + 0x032E,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x032F,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x0330,
            PLAYER_OFFHAND_CRIT_PERCENTAGE = UNIT_END + 0x0331,
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x0332,
            PLAYER_SHIELD_BLOCK = UNIT_END + 0x0339,
            PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE = UNIT_END + 0x033A,
            PLAYER_MASTERY = UNIT_END + 0x033B,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x033C,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x03BC,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x03BD,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x03BE,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x03C5,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x03CC,
            PLAYER_FIELD_MOD_HEALING_DONE_POS = UNIT_END + 0x03D3,
            PLAYER_FIELD_MOD_HEALING_PCT = UNIT_END + 0x03D4,
            PLAYER_FIELD_MOD_HEALING_DONE_PCT = UNIT_END + 0x03D5,
            PLAYER_FIELD_MOD_SPELL_POWER_PCT = UNIT_END + 0x03D6,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x03D7,
            PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = UNIT_END + 0x03D8,
            PLAYER_FIELD_BYTES = UNIT_END + 0x03D9,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x03DA,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x03DB,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x03DC,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x03E8,
            PLAYER_FIELD_KILLS = UNIT_END + 0x03F4,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x03F5,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x03F6,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x03F7,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x03F8,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x03F9,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x03FA,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x0414,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x0429,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x042A,
            PLAYER_FIELD_MAX_LEVEL = UNIT_END + 0x042B,
            PLAYER_FIELD_DAILY_QUESTS_1 = UNIT_END + 0x042C,
            PLAYER_RUNE_REGEN_1 = UNIT_END + 0x0445,
            PLAYER_NO_REAGENT_COST_1 = UNIT_END + 0x0449,
            PLAYER_FIELD_GLYPH_SLOTS_1 = UNIT_END + 0x044C,
            PLAYER_FIELD_GLYPHS_1 = UNIT_END + 0x0452,
            PLAYER_GLYPHS_ENABLED = UNIT_END + 0x0458,
            PLAYER_PET_SPELL_POWER = UNIT_END + 0x0459,
            MAX = UNIT_END + 0x045A
        }
    }
}
