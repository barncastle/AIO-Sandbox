...
namespace TBC_5965
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x0403,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x040A,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x044A,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x044B,
            PLAYER_FIELD_POSSTAT0 = UNIT_END + 0x044C,
            PLAYER_FIELD_POSSTAT1 = UNIT_END + 0x044D,
            PLAYER_FIELD_POSSTAT2 = UNIT_END + 0x044E,
            PLAYER_FIELD_POSSTAT3 = UNIT_END + 0x044F,
            PLAYER_FIELD_POSSTAT4 = UNIT_END + 0x0450,
            PLAYER_FIELD_NEGSTAT0 = UNIT_END + 0x0451,
            PLAYER_FIELD_NEGSTAT1 = UNIT_END + 0x0452,
            PLAYER_FIELD_NEGSTAT2 = UNIT_END + 0x0453,
            PLAYER_FIELD_NEGSTAT3 = UNIT_END + 0x0454,
            PLAYER_FIELD_NEGSTAT4 = UNIT_END + 0x0455,
            PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE = UNIT_END + 0x0456,
            PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE = UNIT_END + 0x045D,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x0464,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x046B,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x0472,
            PLAYER_FIELD_MOD_HEALING_DONE_POS = UNIT_END + 0x0479,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x047A,
            PLAYER_FIELD_BYTES = UNIT_END + 0x047B,
            PLAYER_AMMO_ID = UNIT_END + 0x047C,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x047D,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x047E,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x047F,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x048B,
            PLAYER_FIELD_SESSION_KILLS = UNIT_END + 0x0497,
            PLAYER_FIELD_YESTERDAY_KILLS = UNIT_END + 0x0498,
            PLAYER_FIELD_LAST_WEEK_KILLS = UNIT_END + 0x0499,
            PLAYER_FIELD_THIS_WEEK_KILLS = UNIT_END + 0x049A,
            PLAYER_FIELD_THIS_WEEK_CONTRIBUTION = UNIT_END + 0x049B,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x049C,
            PLAYER_FIELD_LIFETIME_DISHONORBALE_KILLS = UNIT_END + 0x049D,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x049E,
            PLAYER_FIELD_LAST_WEEK_CONTRIBUTION = UNIT_END + 0x049F,
            PLAYER_FIELD_LAST_WEEK_RANK = UNIT_END + 0x04A0,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x04A1,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x04A2,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x04A3,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x04B7,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x04C0,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x04C1,
            MAX = UNIT_END + 0x04C2
        }
    }
}
