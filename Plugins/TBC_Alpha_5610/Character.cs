...
namespace TBC_Alpha_5610
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_FIELD_INV_SLOT_HEAD = UNIT_END + 0x0176,
            PLAYER_FIELD_PACK_SLOT_1 = UNIT_END + 0x01A4,
            PLAYER_FIELD_BANK_SLOT_1 = UNIT_END + 0x01C4,
            PLAYER_FIELD_BANKBAG_SLOT_1 = UNIT_END + 0x01F4,
            PLAYER_FIELD_VENDORBUYBACK_SLOT_1 = UNIT_END + 0x0200,
            PLAYER_FIELD_KEYRING_SLOT_1 = UNIT_END + 0x0218,
            PLAYER_FARSIGHT = UNIT_END + 0x0258,
            PLAYER__FIELD_COMBO_TARGET = UNIT_END + 0x025A,
            PLAYER_XP = UNIT_END + 0x025C,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x025D,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x025E,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x03DE,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x03DF,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x03E0,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x03E1,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x03E2,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x03E3,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x03E4,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x03E5,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x03E6,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x03E7,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x0427,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x0428,
            PLAYER_FIELD_POSSTAT0 = UNIT_END + 0x0429,
            PLAYER_FIELD_POSSTAT1 = UNIT_END + 0x042A,
            PLAYER_FIELD_POSSTAT2 = UNIT_END + 0x042B,
            PLAYER_FIELD_POSSTAT3 = UNIT_END + 0x042C,
            PLAYER_FIELD_POSSTAT4 = UNIT_END + 0x042D,
            PLAYER_FIELD_NEGSTAT0 = UNIT_END + 0x042E,
            PLAYER_FIELD_NEGSTAT1 = UNIT_END + 0x042F,
            PLAYER_FIELD_NEGSTAT2 = UNIT_END + 0x0430,
            PLAYER_FIELD_NEGSTAT3 = UNIT_END + 0x0431,
            PLAYER_FIELD_NEGSTAT4 = UNIT_END + 0x0432,
            PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE = UNIT_END + 0x0433,
            PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE = UNIT_END + 0x043A,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x0441,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x0448,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x044F,
            PLAYER_FIELD_BYTES = UNIT_END + 0x0456,
            PLAYER_AMMO_ID = UNIT_END + 0x0457,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x0458,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x0459,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x045A,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x0466,
            PLAYER_FIELD_SESSION_KILLS = UNIT_END + 0x0472,
            PLAYER_FIELD_YESTERDAY_KILLS = UNIT_END + 0x0473,
            PLAYER_FIELD_LAST_WEEK_KILLS = UNIT_END + 0x0474,
            PLAYER_FIELD_THIS_WEEK_KILLS = UNIT_END + 0x0475,
            PLAYER_FIELD_THIS_WEEK_CONTRIBUTION = UNIT_END + 0x0476,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x0477,
            PLAYER_FIELD_LIFETIME_DISHONORBALE_KILLS = UNIT_END + 0x0478,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x0479,
            PLAYER_FIELD_LAST_WEEK_CONTRIBUTION = UNIT_END + 0x047A,
            PLAYER_FIELD_LAST_WEEK_RANK = UNIT_END + 0x047B,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x047C,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x047D,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x047E,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x0492,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x04A4,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x04A5,
            MAX = UNIT_END + 0x04A6
        }
    }
}
