...
namespace TBC_6577
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER__FIELD_KNOWN_TITLES = UNIT_END + 0x0274,
            PLAYER_XP = UNIT_END + 0x0276,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x0277,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x0278,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x03F8,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x03F9,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x03FA,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x03FB,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x03FC,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x03FD,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x03FE,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x03FF,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x0400,
            PLAYER_OFFHAND_CRIT_PERCENTAGE = UNIT_END + 0x0401,
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x0402,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x0409,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x0449,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x044A,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x044B,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x0452,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x0459,
            PLAYER_FIELD_MOD_HEALING_DONE_POS = UNIT_END + 0x0460,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x0461,
            PLAYER_FIELD_BYTES = UNIT_END + 0x0462,
            PLAYER_AMMO_ID = UNIT_END + 0x0463,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x0464,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x0465,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x0466,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x0472,
            PLAYER_FIELD_KILLS = UNIT_END + 0x047E,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x047F,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x0480,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x0481,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x0482,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x0483,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x0484,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x049B,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x04AA,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x04AB,
            PLAYER_FIELD_MOD_MANA_REGEN = UNIT_END + 0x04AC,
            PLAYER_FIELD_MOD_MANA_REGEN_INTERRUPT = UNIT_END + 0x04AD,
            PLAYER_FIELD_MAX_LEVEL = UNIT_END + 0x04AE,
            PLAYER_FIELD_DAILY_QUESTS_1 = UNIT_END + 0x04AF,
            PLAYER_FIELD_PADDING = UNIT_END + 0x04B9,
            MAX = UNIT_END + 0x04BA
        }
    }
}
