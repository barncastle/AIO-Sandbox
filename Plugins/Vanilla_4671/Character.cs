...
namespace Vanilla_4671
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            UNIT_FIELD_AURAFLAGS = OBJECT_END + 0x0069,
            UNIT_FIELD_AURALEVELS = OBJECT_END + 0x0071,
            UNIT_FIELD_AURAAPPLICATIONS = OBJECT_END + 0x007D,
            UNIT_FIELD_AURASTATE = OBJECT_END + 0x0089,
            UNIT_FIELD_BASEATTACKTIME = OBJECT_END + 0x008A,
            UNIT_FIELD_RANGEDATTACKTIME = OBJECT_END + 0x008C,
            UNIT_FIELD_BOUNDINGRADIUS = OBJECT_END + 0x008D,
            UNIT_FIELD_COMBATREACH = OBJECT_END + 0x008E,
            UNIT_FIELD_DISPLAYID = OBJECT_END + 0x008F,
            UNIT_FIELD_NATIVEDISPLAYID = OBJECT_END + 0x0090,
            UNIT_FIELD_MOUNTDISPLAYID = OBJECT_END + 0x0091,
            UNIT_FIELD_MINDAMAGE = OBJECT_END + 0x0092,
            UNIT_FIELD_MAXDAMAGE = OBJECT_END + 0x0093,
            UNIT_FIELD_MINOFFHANDDAMAGE = OBJECT_END + 0x0094,
            UNIT_FIELD_MAXOFFHANDDAMAGE = OBJECT_END + 0x0095,
            UNIT_FIELD_BYTES_1 = OBJECT_END + 0x0096,
            UNIT_FIELD_PETNUMBER = OBJECT_END + 0x0097,
            UNIT_FIELD_PET_NAME_TIMESTAMP = OBJECT_END + 0x0098,
            UNIT_FIELD_PETEXPERIENCE = OBJECT_END + 0x0099,
            UNIT_FIELD_PETNEXTLEVELEXP = OBJECT_END + 0x009A,
            UNIT_DYNAMIC_FLAGS = OBJECT_END + 0x009B,
            UNIT_CHANNEL_SPELL = OBJECT_END + 0x009C,
            UNIT_MOD_CAST_SPEED = OBJECT_END + 0x009D,
            UNIT_CREATED_BY_SPELL = OBJECT_END + 0x009E,
            UNIT_NPC_FLAGS = OBJECT_END + 0x009F,
            UNIT_NPC_EMOTESTATE = OBJECT_END + 0x00A0,
            UNIT_TRAINING_POINTS = OBJECT_END + 0x00A1,
            UNIT_FIELD_STAT0 = OBJECT_END + 0x00A2,
            UNIT_FIELD_STAT1 = OBJECT_END + 0x00A3,
            UNIT_FIELD_STAT2 = OBJECT_END + 0x00A4,
            UNIT_FIELD_STAT3 = OBJECT_END + 0x00A5,
            UNIT_FIELD_STAT4 = OBJECT_END + 0x00A6,
            UNIT_FIELD_RESISTANCES = OBJECT_END + 0x00A7,
            UNIT_FIELD_ATTACKPOWER = OBJECT_END + 0x00AE,
            UNIT_FIELD_BASE_MANA = OBJECT_END + 0x00AF,
            UNIT_FIELD_BASE_HEALTH = OBJECT_END + 0x00B0,
            UNIT_FIELD_ATTACK_POWER_MODS = OBJECT_END + 0x00B1,
            UNIT_FIELD_BYTES_2 = OBJECT_END + 0x00B2,
            UNIT_FIELD_RANGEDATTACKPOWER = OBJECT_END + 0x00B3,
            UNIT_FIELD_RANGED_ATTACK_POWER_MODS = OBJECT_END + 0x00B4,
            UNIT_FIELD_MINRANGEDDAMAGE = OBJECT_END + 0x00B5,
            UNIT_FIELD_MAXRANGEDDAMAGE = OBJECT_END + 0x00B6,
            UNIT_FIELD_POWER_COST_MODIFIER = OBJECT_END + 0x00B7,
            UNIT_FIELD_POWER_COST_MULTIPLIER = OBJECT_END + 0x00BE,
            UNIT_FIELD_PADDING = OBJECT_END + 0x00C5,
            UNIT_END = OBJECT_END + 0x00C6,
            ...
            PLAYER_FIELD_VENDORBUYBACK_SLOT = UNIT_END + 0x01B6,
            PLAYER_FARSIGHT = UNIT_END + 0x01B8,
            PLAYER__FIELD_COMBO_TARGET = UNIT_END + 0x01BA,
            PLAYER_FIELD_BUYBACK_NPC = UNIT_END + 0x01BC,
            PLAYER_XP = UNIT_END + 0x01BE,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x01BF,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x01C0,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x0340,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x0341,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x0342,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x0343,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x0344,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x0345,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x0346,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x0347,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x0348,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x0349,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x0389,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x038A,
            PLAYER_FIELD_POSSTAT0 = UNIT_END + 0x038B,
            PLAYER_FIELD_POSSTAT1 = UNIT_END + 0x038C,
            PLAYER_FIELD_POSSTAT2 = UNIT_END + 0x038D,
            PLAYER_FIELD_POSSTAT3 = UNIT_END + 0x038E,
            PLAYER_FIELD_POSSTAT4 = UNIT_END + 0x038F,
            PLAYER_FIELD_NEGSTAT0 = UNIT_END + 0x0390,
            PLAYER_FIELD_NEGSTAT1 = UNIT_END + 0x0391,
            PLAYER_FIELD_NEGSTAT2 = UNIT_END + 0x0392,
            PLAYER_FIELD_NEGSTAT3 = UNIT_END + 0x0393,
            PLAYER_FIELD_NEGSTAT4 = UNIT_END + 0x0394,
            PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE = UNIT_END + 0x0395,
            PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE = UNIT_END + 0x039C,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x03A3,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x03AA,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x03B1,
            PLAYER_FIELD_BYTES = UNIT_END + 0x03B8,
            PLAYER_AMMO_ID = UNIT_END + 0x03B9,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x03BA,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x03BB,
            PLAYER_FIELD_BUYBACK_ITEM_ID = UNIT_END + 0x03BC,
            PLAYER_FIELD_BUYBACK_RANDOM_PROPERTIES_ID = UNIT_END + 0x03BD,
            PLAYER_FIELD_BUYBACK_SEED = UNIT_END + 0x03BE,
            PLAYER_FIELD_BUYBACK_PRICE = UNIT_END + 0x03BF,
            PLAYER_FIELD_BUYBACK_DURABILITY = UNIT_END + 0x03C0,
            PLAYER_FIELD_BUYBACK_COUNT = UNIT_END + 0x03C1,
            PLAYER_FIELD_SESSION_KILLS = UNIT_END + 0x03C2,
            PLAYER_FIELD_YESTERDAY_KILLS = UNIT_END + 0x03C3,
            PLAYER_FIELD_LAST_WEEK_KILLS = UNIT_END + 0x03C4,
            PLAYER_FIELD_THIS_WEEK_KILLS = UNIT_END + 0x03C5,
            PLAYER_FIELD_THIS_WEEK_CONTRIBUTION = UNIT_END + 0x03C6,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x03C7,
            PLAYER_FIELD_LIFETIME_DISHONORBALE_KILLS = UNIT_END + 0x03C8,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x03C9,
            PLAYER_FIELD_LAST_WEEK_CONTRIBUTION = UNIT_END + 0x03CA,
            PLAYER_FIELD_LAST_WEEK_RANK = UNIT_END + 0x03CB,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x03CC,
            PLAYER_FIELD_PADDING = UNIT_END + 0x03CD,
            MAX = UNIT_END + 0x03CE
        }
    }
}
