...
namespace WotLK_8874
{
    public class Character : BaseCharacter
    {
        ...
        public override IPacketWriter BuildUpdate()
        {
            ...
            writer.WriteUInt16(0); // MoveFlags2? -- size changed
        ...
        internal enum Fields
        {
            ...
            UNIT_FIELD_AURASTATE = OBJECT_END + 0x002E,
            UNIT_FIELD_BASEATTACKTIME = OBJECT_END + 0x002F,
            UNIT_FIELD_RANGEDATTACKTIME = OBJECT_END + 0x0031,
            UNIT_FIELD_BOUNDINGRADIUS = OBJECT_END + 0x0032,
            UNIT_FIELD_COMBATREACH = OBJECT_END + 0x0033,
            UNIT_FIELD_DISPLAYID = OBJECT_END + 0x0034,
            UNIT_FIELD_NATIVEDISPLAYID = OBJECT_END + 0x0035,
            UNIT_FIELD_MOUNTDISPLAYID = OBJECT_END + 0x0036,
            UNIT_FIELD_MINDAMAGE = OBJECT_END + 0x0037,
            UNIT_FIELD_MAXDAMAGE = OBJECT_END + 0x0038,
            UNIT_FIELD_MINOFFHANDDAMAGE = OBJECT_END + 0x0039,
            UNIT_FIELD_MAXOFFHANDDAMAGE = OBJECT_END + 0x003A,
            UNIT_FIELD_BYTES_1 = OBJECT_END + 0x003B,
            UNIT_FIELD_PETNUMBER = OBJECT_END + 0x003C,
            UNIT_FIELD_PET_NAME_TIMESTAMP = OBJECT_END + 0x003D,
            UNIT_FIELD_PETEXPERIENCE = OBJECT_END + 0x003E,
            UNIT_FIELD_PETNEXTLEVELEXP = OBJECT_END + 0x003F,
            UNIT_DYNAMIC_FLAGS = OBJECT_END + 0x0040,
            UNIT_CHANNEL_SPELL = OBJECT_END + 0x0041,
            UNIT_MOD_CAST_SPEED = OBJECT_END + 0x0042,
            UNIT_CREATED_BY_SPELL = OBJECT_END + 0x0043,
            UNIT_NPC_FLAGS = OBJECT_END + 0x0044,
            UNIT_NPC_EMOTESTATE = OBJECT_END + 0x0045,
            UNIT_FIELD_STAT0 = OBJECT_END + 0x0046,
            UNIT_FIELD_STAT1 = OBJECT_END + 0x0047,
            UNIT_FIELD_STAT2 = OBJECT_END + 0x0048,
            UNIT_FIELD_STAT3 = OBJECT_END + 0x0049,
            UNIT_FIELD_STAT4 = OBJECT_END + 0x004A,
            UNIT_FIELD_POSSTAT0 = OBJECT_END + 0x004B,
            UNIT_FIELD_POSSTAT1 = OBJECT_END + 0x004C,
            UNIT_FIELD_POSSTAT2 = OBJECT_END + 0x004D,
            UNIT_FIELD_POSSTAT3 = OBJECT_END + 0x004E,
            UNIT_FIELD_POSSTAT4 = OBJECT_END + 0x004F,
            UNIT_FIELD_NEGSTAT0 = OBJECT_END + 0x0050,
            UNIT_FIELD_NEGSTAT1 = OBJECT_END + 0x0051,
            UNIT_FIELD_NEGSTAT2 = OBJECT_END + 0x0052,
            UNIT_FIELD_NEGSTAT3 = OBJECT_END + 0x0053,
            UNIT_FIELD_NEGSTAT4 = OBJECT_END + 0x0054,
            UNIT_FIELD_RESISTANCES = OBJECT_END + 0x0055,
            UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE = OBJECT_END + 0x005C,
            UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE = OBJECT_END + 0x0063,
            UNIT_FIELD_BASE_MANA = OBJECT_END + 0x006A,
            UNIT_FIELD_BASE_HEALTH = OBJECT_END + 0x006B,
            UNIT_FIELD_BYTES_2 = OBJECT_END + 0x006C,
            UNIT_FIELD_ATTACK_POWER = OBJECT_END + 0x006D,
            UNIT_FIELD_ATTACK_POWER_MODS = OBJECT_END + 0x006E,
            UNIT_FIELD_ATTACK_POWER_MULTIPLIER = OBJECT_END + 0x006F,
            UNIT_FIELD_RANGED_ATTACK_POWER = OBJECT_END + 0x0070,
            UNIT_FIELD_RANGED_ATTACK_POWER_MODS = OBJECT_END + 0x0071,
            UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER = OBJECT_END + 0x0072,
            UNIT_FIELD_MINRANGEDDAMAGE = OBJECT_END + 0x0073,
            UNIT_FIELD_MAXRANGEDDAMAGE = OBJECT_END + 0x0074,
            UNIT_FIELD_POWER_COST_MODIFIER = OBJECT_END + 0x0075,
            UNIT_FIELD_POWER_COST_MULTIPLIER = OBJECT_END + 0x007C,
            UNIT_FIELD_MAXHEALTHMODIFIER = OBJECT_END + 0x0083,
            UNIT_FIELD_HOVERHEIGHT = OBJECT_END + 0x0084,
            UNIT_FIELD_PADDING = OBJECT_END + 0x0085,
            UNIT_END = OBJECT_END + 0x0086,
            ...
            PLAYER_FIELD_QUESTBAG_SLOT_1 = UNIT_END + 0x0316,
            PLAYER_FARSIGHT = UNIT_END + 0x0356,
            PLAYER__FIELD_KNOWN_TITLES = UNIT_END + 0x0358,
            PLAYER_FIELD_KNOWN_CURRENCIES = UNIT_END + 0x035A,
            PLAYER_XP = UNIT_END + 0x035C,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x035D,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x035E,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x04DE,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x04DF,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x04E0,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x04E1,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x04E2,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x04E3,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x04E4,
            PLAYER_EXPERTISE = UNIT_END + 0x04E5,
            PLAYER_OFFHAND_EXPERTISE = UNIT_END + 0x04E6,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x04E7,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x04E8,
            PLAYER_OFFHAND_CRIT_PERCENTAGE = UNIT_END + 0x04E9,
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x04EA,
            PLAYER_SHIELD_BLOCK = UNIT_END + 0x04F1,
            PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE = UNIT_END + 0x04F2,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x04F3,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x0573,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x0574,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x0575,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x057C,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x0583,
            PLAYER_FIELD_MOD_HEALING_DONE_POS = UNIT_END + 0x058A,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x058B,
            PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = UNIT_END + 0x058C,
            PLAYER_FIELD_BYTES = UNIT_END + 0x058D,
            PLAYER_AMMO_ID = UNIT_END + 0x058E,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x058F,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x0590,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x0591,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x059D,
            PLAYER_FIELD_KILLS = UNIT_END + 0x05A9,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x05AA,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x05AB,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x05AC,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x05AD,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x05AE,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x05AF,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x05C8,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x05DA,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x05DB,
            PLAYER_FIELD_MOD_MANA_REGEN = UNIT_END + 0x05DC,
            PLAYER_FIELD_MOD_MANA_REGEN_INTERRUPT = UNIT_END + 0x05DD,
            PLAYER_FIELD_MAX_LEVEL = UNIT_END + 0x05DE,
            PLAYER_FIELD_DAILY_QUESTS_1 = UNIT_END + 0x05DF,
            PLAYER_RUNE_REGEN_1 = UNIT_END + 0x05F8,
            PLAYER_NO_REAGENT_COST_1 = UNIT_END + 0x05FC,
            PLAYER_FIELD_GLYPH_SLOTS_1 = UNIT_END + 0x05FF,
            PLAYER_FIELD_GLYPHS_1 = UNIT_END + 0x0607,
            PLAYER_GLYPHS_ENABLED = UNIT_END + 0x060F,
            PLAYER_FIELD_IGNORE_AURASTATE = UNIT_END + 0x0610,
            PLAYER_FIELD_PADDING = UNIT_END + 0x0613,
            MAX = UNIT_END + 0x0614
        }
    }
}
