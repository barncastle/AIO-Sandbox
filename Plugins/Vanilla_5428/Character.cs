...
namespace Vanilla_5428
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_FIELD_KEYRING_SLOT_1 = UNIT_END + 0x01CE,
            PLAYER_FARSIGHT = UNIT_END + 0x020E,
            PLAYER__FIELD_COMBO_TARGET = UNIT_END + 0x0210,
            PLAYER_XP = UNIT_END + 0x0212,
            PLAYER_NEXT_LEVEL_XP = UNIT_END + 0x0213,
            PLAYER_SKILL_INFO_1_1 = UNIT_END + 0x0214,
            PLAYER_CHARACTER_POINTS1 = UNIT_END + 0x0394,
            PLAYER_CHARACTER_POINTS2 = UNIT_END + 0x0395,
            PLAYER_TRACK_CREATURES = UNIT_END + 0x0396,
            PLAYER_TRACK_RESOURCES = UNIT_END + 0x0397,
            PLAYER_BLOCK_PERCENTAGE = UNIT_END + 0x0398,
            PLAYER_DODGE_PERCENTAGE = UNIT_END + 0x0399,
            PLAYER_PARRY_PERCENTAGE = UNIT_END + 0x039A,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x039B,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x039C,
            PLAYER_EXPLORED_ZONES_1 = UNIT_END + 0x039D,
            PLAYER_REST_STATE_EXPERIENCE = UNIT_END + 0x03DD,
            PLAYER_FIELD_COINAGE = UNIT_END + 0x03DE,
            PLAYER_FIELD_POSSTAT0 = UNIT_END + 0x03DF,
            PLAYER_FIELD_POSSTAT1 = UNIT_END + 0x03E0,
            PLAYER_FIELD_POSSTAT2 = UNIT_END + 0x03E1,
            PLAYER_FIELD_POSSTAT3 = UNIT_END + 0x03E2,
            PLAYER_FIELD_POSSTAT4 = UNIT_END + 0x03E3,
            PLAYER_FIELD_NEGSTAT0 = UNIT_END + 0x03E4,
            PLAYER_FIELD_NEGSTAT1 = UNIT_END + 0x03E5,
            PLAYER_FIELD_NEGSTAT2 = UNIT_END + 0x03E6,
            PLAYER_FIELD_NEGSTAT3 = UNIT_END + 0x03E7,
            PLAYER_FIELD_NEGSTAT4 = UNIT_END + 0x03E8,
            PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE = UNIT_END + 0x03E9,
            PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE = UNIT_END + 0x03F0,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = UNIT_END + 0x03F7,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = UNIT_END + 0x03FE,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = UNIT_END + 0x0405,
            PLAYER_FIELD_BYTES = UNIT_END + 0x040C,
            PLAYER_AMMO_ID = UNIT_END + 0x040D,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x040E,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x040F,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x0410,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x041C,
            PLAYER_FIELD_SESSION_KILLS = UNIT_END + 0x0428,
            PLAYER_FIELD_YESTERDAY_KILLS = UNIT_END + 0x0429,
            PLAYER_FIELD_LAST_WEEK_KILLS = UNIT_END + 0x042A,
            PLAYER_FIELD_THIS_WEEK_KILLS = UNIT_END + 0x042B,
            PLAYER_FIELD_THIS_WEEK_CONTRIBUTION = UNIT_END + 0x042C,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x042D,
            PLAYER_FIELD_LIFETIME_DISHONORBALE_KILLS = UNIT_END + 0x042E,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x042F,
            PLAYER_FIELD_LAST_WEEK_CONTRIBUTION = UNIT_END + 0x0430,
            PLAYER_FIELD_LAST_WEEK_RANK = UNIT_END + 0x0431,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x0432,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x0433,
            MAX = UNIT_END + 0x0434
        }
    }
}
