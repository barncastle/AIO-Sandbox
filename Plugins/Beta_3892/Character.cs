...
namespace Beta_3892
{
    ...
    public class Character : ICharacter
    {
        ...
        internal enum Fields
        {
            ...
            UNIT_FIELD_DISPLAYID = 133,
            UNIT_FIELD_NATIVEDISPLAYID = 134,
            ...
            UNIT_ATTACK_POWER_MODS = 164,
            UNIT_FIELD_PADDING = 165,
            PLAYER_SELECTION = 166,
            PLAYER_DUEL_ARBITER = 168,
            PLAYER_GUILDID = 170,
            PLAYER_GUILDRANK = 171,
            PLAYER_BYTES = 172,
            PLAYER_BYTES_2 = 173,
            PLAYER_BYTES_3 = 174,
            PLAYER_DUEL_TEAM = 175,
            PLAYER_GUILD_TIMESTAMP = 176,
            PLAYER_FIELD_PAD_0 = 177,
            PLAYER_FIELD_INV_SLOT_HEAD = 178,
            PLAYER_FIELD_PACK_SLOT_1 = 224,
            PLAYER_FIELD_BANK_SLOT_1 = 256,
            PLAYER_FIELD_BANKBAG_SLOT_1 = 304,
            PLAYER_FIELD_VENDORBUYBACK_SLOT = 316,
            PLAYER_FARSIGHT = 318,
            PLAYER_FIELD_COMBO_TARGET = 320,
            PLAYER_FIELD_BUYBACK_NPC = 322,
            PLAYER_XP = 324,
            PLAYER_NEXT_LEVEL_XP = 325,
            PLAYER_SKILL_INFO_1_1 = 326,
            PLAYER_QUEST_LOG_1_1 = 710,
            ...
            PLAYER_CRIT_PERCENTAGE = 778,
            PLAYER_EXPLORED_ZONES_1 = 779,
            PLAYER_REST_STATE_EXPERIENCE = 811,
            PLAYER_FIELD_COINAGE = 812,
            PLAYER_FIELD_POSSTAT0 = 813,
            PLAYER_FIELD_POSSTAT1 = 814,
            PLAYER_FIELD_POSSTAT2 = 815,
            PLAYER_FIELD_POSSTAT3 = 816,
            PLAYER_FIELD_POSSTAT4 = 817,
            PLAYER_FIELD_NEGSTAT0 = 818,
            PLAYER_FIELD_NEGSTAT1 = 819,
            PLAYER_FIELD_NEGSTAT2 = 820,
            PLAYER_FIELD_NEGSTAT3 = 821,
            PLAYER_FIELD_NEGSTAT4 = 822,
            PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE = 823,
            PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE = 830,
            PLAYER_FIELD_MOD_DAMAGE_DONE_POS = 837,
            PLAYER_FIELD_MOD_DAMAGE_DONE_NEG = 844,
            PLAYER_FIELD_MOD_DAMAGE_DONE_PCT = 851,
            PLAYER_FIELD_BYTES = 858,
            PLAYER_AMMO_ID = 859,
            PLAYER_FIELD_PVP_MEDALS = 860,
            PLAYER_FIELD_BUYBACK_ITEM_ID = 861,
            PLAYER_FIELD_BUYBACK_RANDOM_PROPERTIES_ID = 862,
            PLAYER_FIELD_BUYBACK_SEED = 863,
            PLAYER_FIELD_BUYBACK_PRICE = 864,
            PLAYER_FIELD_PADDING = 865,
            MAX = 866,
        }
    }
}
