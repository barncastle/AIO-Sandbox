...
namespace WotLK_10026
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_FAKE_INEBRIATION = UNIT_END + 0x0095,
            ...
            PLAYER_FIELD_MOD_HEALING_PCT = UNIT_END + 0x03FB,
            PLAYER_FIELD_MOD_HEALING_DONE_PCT = UNIT_END + 0x03FC,
            PLAYER_FIELD_MOD_TARGET_RESISTANCE = UNIT_END + 0x03FD,
            PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE = UNIT_END + 0x03FE,
            PLAYER_FIELD_BYTES = UNIT_END + 0x03FF,
            PLAYER_AMMO_ID = UNIT_END + 0x0400,
            PLAYER_SELF_RES_SPELL = UNIT_END + 0x0401,
            PLAYER_FIELD_PVP_MEDALS = UNIT_END + 0x0402,
            PLAYER_FIELD_BUYBACK_PRICE_1 = UNIT_END + 0x0403,
            PLAYER_FIELD_BUYBACK_TIMESTAMP_1 = UNIT_END + 0x040F,
            PLAYER_FIELD_KILLS = UNIT_END + 0x041B,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x041C,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x041D,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x041E,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x041F,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x0420,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x0421,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x043A,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x044F,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x0450,
            PLAYER_FIELD_MAX_LEVEL = UNIT_END + 0x0451,
            PLAYER_FIELD_DAILY_QUESTS_1 = UNIT_END + 0x0452,
            PLAYER_RUNE_REGEN_1 = UNIT_END + 0x046B,
            PLAYER_NO_REAGENT_COST_1 = UNIT_END + 0x046F,
            PLAYER_FIELD_GLYPH_SLOTS_1 = UNIT_END + 0x0472,
            PLAYER_FIELD_GLYPHS_1 = UNIT_END + 0x0478,
            PLAYER_GLYPHS_ENABLED = UNIT_END + 0x047E,
            PLAYER_FIELD_PADDING = UNIT_END + 0x047F,
            MAX = UNIT_END + 0x0480
        }
    }
}
