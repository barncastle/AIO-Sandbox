...
namespace TBC_7561
{
    public class Character : BaseCharacter
    {
        ...
        internal enum Fields
        {
            ...
            PLAYER_EXPERTISE = UNIT_END + 0x03FF,
            PLAYER_CRIT_PERCENTAGE = UNIT_END + 0x0400,
            PLAYER_RANGED_CRIT_PERCENTAGE = UNIT_END + 0x0401,
            PLAYER_OFFHAND_CRIT_PERCENTAGE = UNIT_END + 0x0402,
            PLAYER_SPELL_CRIT_PERCENTAGE1 = UNIT_END + 0x0403,
            PLAYER_SHIELD_BLOCK = UNIT_END + 0x040A,
            ...
            PLAYER_FIELD_KILLS = UNIT_END + 0x0480,
            PLAYER_FIELD_TODAY_CONTRIBUTION = UNIT_END + 0x0481,
            PLAYER_FIELD_YESTERDAY_CONTRIBUTION = UNIT_END + 0x0482,
            PLAYER_FIELD_LIFETIME_HONORBALE_KILLS = UNIT_END + 0x0483,
            PLAYER_FIELD_BYTES2 = UNIT_END + 0x0484,
            PLAYER_FIELD_WATCHED_FACTION_INDEX = UNIT_END + 0x0485,
            PLAYER_FIELD_COMBAT_RATING_1 = UNIT_END + 0x0486,
            PLAYER_FIELD_ARENA_TEAM_INFO_1_1 = UNIT_END + 0x049E,
            PLAYER_FIELD_HONOR_CURRENCY = UNIT_END + 0x04B0,
            PLAYER_FIELD_ARENA_CURRENCY = UNIT_END + 0x04B1,
            PLAYER_FIELD_MOD_MANA_REGEN = UNIT_END + 0x04B2,
            PLAYER_FIELD_MOD_MANA_REGEN_INTERRUPT = UNIT_END + 0x04B3,
            PLAYER_FIELD_MAX_LEVEL = UNIT_END + 0x04B4,
            PLAYER_FIELD_DAILY_QUESTS_1 = UNIT_END + 0x04B5,
